...
\begin{center}
\adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{./differntpriorshapes.png}
\end{center}
On the left is a
...
\begin{center}
\adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{q10.png}
\end{center}
...
closely aligned to the direction of the data points.
    ...
    { \hspace*{\fill} \\}
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_14_1.png}
    \end{center}
    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_14_2.png}
    \end{center}
    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_14_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
The length scale encodes the assumption of smoothness of the function.
    ...
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_16_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
but also has a high uncertainity.
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_18_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
is described by {[}xsin(x), xcos(x){]}
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_26_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
which should sum to one.
    ...
    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_31_0.png}
    \end{center}
    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_31_2.png}
    \end{center}
    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_31_4.png}
    \end{center}
    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_31_6.png}
    \end{center}
    { \hspace*{\fill} \\}

    \begin{center}
    \adjustimage{max size={0.5\linewidth}{0.5\paperheight}}{output_31_8.png}
    \end{center}
    { \hspace*{\fill} \\}
